									...
									<form action="" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<div class="form-group">
												...
												<input type="text" id="donationinput1" value="<?= set_value('nama_karyawan'); ?>" class="form-control" placeholder="Nama Karyawan" name="nama_karyawan">
												<?= form_error('nama_karyawan', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group">
												<label for="donationinput2" class="sr-only">Email</label>
												<input type="email" id="donationinput2" value="<?= set_value('email'); ?>" class="form-control" placeholder="Email" name="email">
												<?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group">
												<label for="donationinput3" class="sr-only">Password</label>
												<input type="password" id="donationinput3" value="<?= set_value('password'); ?>" class="form-control" placeholder="Password" name="password">
